...
public final class WatchNotificationRelay: @unchecked Sendable {
    private static let logger = Logger(subsystem: "app.notchtune", category: "WatchNotificationRelay")
    ...
    private let queue = DispatchQueue(label: "app.notchtune.watch.relay")
