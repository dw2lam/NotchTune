...
private struct SetupCommand {
    ...
    private func install() throws {
        ...
        print("Installed NotchTune Codex hooks.")
    ...
    private func uninstall() throws {
        ...
        print("Removed NotchTune Codex hooks.")
        print("Codex dir: \(status.codexDirectory.path)")
    ...
    private func installClaude() throws {
        ...
        print("Installed NotchTune Claude hooks.")
        print("Claude dir: \(status.claudeDirectory.path)")
        print("Hooks binary: \(hooksBinary.path)")
        if status.hasClaudeIslandHooks {
            print("Note: claude-island hooks are still present alongside NotchTune hooks.")
        }
    }
    ...
    private func uninstallClaude() throws {
        ...
        print("Removed NotchTune Claude hooks.")
        print("Claude dir: \(status.claudeDirectory.path)")
        if status.hasClaudeIslandHooks {
    ...
    private func installKimi() throws {
        ...
        print("Installed NotchTune Kimi hooks.")
    ...
    private func uninstallKimi() throws {
        ...
        print("Removed NotchTune Kimi hooks.")
        print("Kimi dir: \(status.kimiDirectory.path)")
...
private enum SetupError: Error, LocalizedError {
    ...
    var errorDescription: String? {
        ...
        case .usage:
            """
            Usage:
              swift run NotchTuneSetup install [--hooks-binary /abs/path/to/NotchTuneHooks] [--codex-dir /abs/path/to/.codex]
              swift run NotchTuneSetup uninstall [--codex-dir /abs/path/to/.codex]
              swift run NotchTuneSetup status [--hooks-binary /abs/path/to/NotchTuneHooks] [--codex-dir /abs/path/to/.codex]
              swift run NotchTuneSetup installClaude [--hooks-binary /abs/path/to/NotchTuneHooks] [--claude-dir /abs/path/to/.claude]
              swift run NotchTuneSetup uninstallClaude [--claude-dir /abs/path/to/.claude]
              swift run NotchTuneSetup statusClaude [--hooks-binary /abs/path/to/NotchTuneHooks] [--claude-dir /abs/path/to/.claude]
              swift run NotchTuneSetup installKimi [--hooks-binary /abs/path/to/NotchTuneHooks] [--kimi-dir /abs/path/to/.kimi]
              swift run NotchTuneSetup uninstallKimi [--kimi-dir /abs/path/to/.kimi]
              swift run NotchTuneSetup statusKimi [--hooks-binary /abs/path/to/NotchTuneHooks] [--kimi-dir /abs/path/to/.kimi]
            """
