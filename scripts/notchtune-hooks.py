...
Drop-in replacement for the Swift NotchTuneHooks binary.
...
Usage (configured in Claude Code settings.json or Codex hooks.json):
    echo '{"hook_event_name":"SessionStart",...}' | python3 notchtune-hooks.py --source claude
"""
...
def socket_path():
    path = os.environ.get("NOTCHTUNE_SOCKET_PATH") or \
