...
base_dir="${NOTCHTUNE_HARNESS_ARTIFACT_DIR:-$repo_root/output/harness/smoke-all-$timestamp}"
...
for scenario in "${scenarios[@]}"; do
    ...
    NOTCHTUNE_HARNESS_SCENARIO="$scenario" \
    NOTCHTUNE_HARNESS_ARTIFACT_DIR="$scenario_dir" \
